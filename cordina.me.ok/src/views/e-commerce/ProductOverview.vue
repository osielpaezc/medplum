    ...
    <TabView>
      <TabPanel header="Details">
        ...
        <p class="line-height-3 text-600 p-0 mx-0 mt-0 mb-4">
          Volutpat maecenas volutpat blandit aliquam etiam erat velit scelerisque in. Duis ultricies
          lacus sed turpis tincidunt id. Sed tempus urna et pharetra. Metus vulputate eu scelerisque
          felis imperdiet proin fermentum. Venenatis urna cursus eget nunc scelerisque viverra
          mauris in. Viverra justo nec ultrices dui sapien eget mi proin. Laoreet suspendisse
        ...
        <ul class="list-none p-0 m-0">
          <li class="pb-5 border-bottom-1 surface-border">
            ...
            <p class="mx-0 mt-0 mb-3 text-600 line-height-3">
              ...
              consectetur lorem donec massa. Imperdiet proin fermentum leo vel orci porta non.
      ...
      <TabPanel header="Shipping and Returns">
        ...
        <p class="line-height-3 text-600 p-0 mx-0 mt-0 mb-4">
          Mattis aliquam faucibus purus in massa tempor nec feugiat nisl. Justo donec enim diam
          vulputate ut pharetra. Tempus egestas sed sed risus. Feugiat sed lectus vestibulum mattis.
          Tristique nulla aliquet enim tortor at auctor urna nunc. Habitant morbi tristique senectus
