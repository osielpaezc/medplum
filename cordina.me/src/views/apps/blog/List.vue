...
<template>
  <div class="card">
    ...
    >
      <template #header>
        <div
          class="flex flex-column sm:flex-row sm:align-items-center sm:justify-content-between gap-3"
        >
            ...
            <div class="p-3">
              <div class="surface-100 cursor-pointer border-round">
                <div class="relative">
                  ...
                  <img
                    :src="item.profile"
                    class="flex absolute w-4rem h-4rem"
  ...
  <div class="card">
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
      ...
      <div class="text-700 text-xl line-height-3 mb-5">
